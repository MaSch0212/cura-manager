...
namespace CuraManager.Views
{
    ...
    public partial class CreateProjectFromWebDialog : ICreateProjectFromWebDialog_Props
    {
        ...
        {
            return await CreateProjectImpl(this, _translationManager, _downloadService, _targetPath, ProjectName, new Uri(WebAddress));
        }
        ...
        public static async Task<PrintElement> CreateProject(string targetPath, string webAddress, string name = null)
        {
            ...
            return await CreateProjectImpl(Application.Current.MainWindow, translationManager, downloadService, targetPath, name, link);
        }

        private static async Task<PrintElement> CreateProjectImpl(Window parentWindow, ITranslationManager translationManager, IDownloadService downloadService, string targetPath, string name, Uri link)
        {
