...
| tech | Updated a couple of libraries this application depends on. |
| tech | Updated to .NET 6.0. |

**Important:** Before updating make sure to install the latest Version of the .NET 6.0 Desktop Runtime from [here](https://dotnet.microsoft.com/en-us/download/dotnet/6.0).
